...
<div class="problem-statement">
                <p></p><p><span style="font-size:18px">Given a sorted array&nbsp;of <strong>N</strong> integers, find the number of distinct absolute values among the elements of the array.&nbsp;</span></p>
